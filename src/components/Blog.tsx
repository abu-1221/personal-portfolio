...
const ARTICLES = [
  {
    ...
    excerpt: "From HSC to pursuing B.Sc. in Computer Science at Jamal Mohamed College. The challenges, learnings, and growth in the field of technology.",
    category: "Journey",
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt: "Building an ESP32-based system using radiation sensors for automated lighting and fan control. A hands-on experience with embedded systems.",
    category: "Tech",
    readTime: "8 min read",
  ...
  {
    title: "Mastering Tally Prime for Business",
    excerpt: "Essential tips for stock and inventory management using Tally Prime. How accounting software streamlines business operations.",
    category: "Skills",
    readTime: "6 min read",
