...
const skills = [
  { 
    category: "Operating Systems & Packages", 
    items: ["DOS", "Windows 8", "MS Word", "MS Excel", "MS PowerPoint"] 
  },
  { 
    category: "Design & DTP", 
    items: ["Photoshop", "CorelDraw", "Web Designing", "Web Development", "UI/UX Design"] 
  },
  { 
    category: "Accounting & Programming", 
    items: ["Tally ERP 9", "Tally Prime", "C (Intermediate)", "Python (Pursuing)"] 
  },
];
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
            Software <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-purple-400">Skill Set</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">
            A versatile skill set spanning design, development, and accounting software.
          </p>
        </motion.div>
