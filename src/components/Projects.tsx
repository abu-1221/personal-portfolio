...
const projects = [
  {
    ...
    description: "ESP32-based smart automation system with radiation sensors.",
    longDescription: "Developed an ESP32-based system using radiation sensors to automate lighting and fan control based on human presence. This IoT project demonstrates practical application of embedded systems and sensor integration for smart home automation.",
    techStack: ["ESP32", "Sensors", "IoT", "Automation", "Arduino"],
    repo: "#",
    demo: "#",
    ...
    demoUrl: "https://images.pexels.com/photos/3912981/pexels-photo-3912981.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
  {
    id: "dtp-design",
    title: "DTP & Book Design",
    category: "Desktop Publishing",
    description: "Professional book covers and certificates using CorelDraw.",
    longDescription: "Designed professional book front pages and certificates using CorelDraw with expertise in both Tamil and English fonts. Demonstrated skills in typography, layout design, and print-ready output preparation.",
    techStack: ["CorelDraw", "Typography", "Tamil Fonts", "English Fonts", "Print Design"],
    repo: "#",
    demo: "#",
    ...
    mediaType: "image",
    mediaUrl: "https://images.pexels.com/photos/1762851/pexels-photo-1762851.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    demoUrl: "https://images.pexels.com/photos/4348404/pexels-photo-4348404.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
  {
    id: "tally-project",
    title: "Tally Stock Management",
    category: "Accounting Software",
    description: "Stock and inventory management using Tally Prime.",
    longDescription: "Implemented comprehensive stock and inventory management solutions using Tally Prime. Managed inventory tracking, stock valuation, and automated reporting for efficient business operations.",
    techStack: ["Tally Prime", "Tally ERP 9", "Inventory Management", "Stock Valuation"],
    repo: "#",
    demo: "#",
    ...
    mediaType: "image",
    mediaUrl: "https://images.pexels.com/photos/669619/pexels-photo-669619.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    demoUrl: "https://images.pexels.com/photos/6863183/pexels-photo-6863183.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
  {
    id: "ms-word-project",
    title: "Advertisement Design",
    category: "MS Office",
    description: "Professional advertisement design with alignment and formatting.",
    longDescription: "Created professional advertisement designs using MS Word with focus on precise alignment and formatting techniques. Demonstrated expertise in document layout, typography, and visual hierarchy.",
    techStack: ["MS Word", "Typography", "Layout Design", "Formatting"],
    repo: "#",
    demo: "#",
    ...
    span: "md:col-span-1 md:row-span-1",
    mediaType: "image",
    mediaUrl: "https://images.pexels.com/photos/590016/pexels-photo-590016.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    demoUrl: "https://images.pexels.com/photos/5816298/pexels-photo-5816298.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
  {
    id: "ppt-project",
    title: "Road Safety Awareness",
    category: "Presentation Design",
    description: "Engaging PowerPoint presentation on road safety.",
    longDescription: "Developed an informative and visually engaging Road Safety Awareness Presentation using MS PowerPoint. Applied design principles to create impactful slides with animations and transitions.",
    techStack: ["MS PowerPoint", "Animation", "Visual Design", "Presentation"],
    repo: "#",
    demo: "#",
    ...
    span: "md:col-span-1 md:row-span-1",
    mediaType: "image",
    mediaUrl: "https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    demoUrl: "https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
  {
    id: "uiux-internship",
    title: "AI Powered Tech Development",
    category: "UI & UX Design",
    description: "Internship project focused on modern UI/UX design.",
    longDescription: "Completed an internship in AI Powered Tech Development with focus on UI & UX Design. Learned modern design principles, user research methodologies, and prototyping techniques for creating intuitive digital interfaces.",
    techStack: ["UI Design", "UX Research", "Prototyping", "Figma", "Adobe XD"],
    repo: "#",
    demo: "#",
    ...
    demoUrl: "https://images.pexels.com/photos/326503/pexels-photo-326503.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
];
  ...
  return (
    <section className="relative z-20 bg-[#0a0a0a] min-h-screen py-32 px-4 md:px-12 overflow-hidden" id="projects">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] right-[-10%] w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-purple-600/10 rounded-full blur-[60px] md:blur-[120px]" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[250px] md:w-[500px] h-[250px] md:h-[500px] bg-blue-600/10 rounded-full blur-[50px] md:blur-[100px]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
            Projects <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-purple-400">Handled</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">
             A curated selection of projects demonstrating diverse skills in IoT, 
             design, accounting software, and presentation development.
          </p>
        </motion.div>
                           ...
                           <div className="flex flex-col md:flex-row h-full">
                                ...
                                <div className="w-full md:w-3/5 p-8 md:p-12 bg-[#121212]">
                                    ...
                                    >
                                        ...
                                        <div className="mb-10">
                                            <h4 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-4">Technologies & Tools</h4>
