      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-10 max-w-md leading-relaxed">
              I'm currently available for freelance projects and open to opportunities.
              If you have a project that needs some creative touch, I'd love to hear about it.
            </p>

            <div className="flex flex-col gap-6 mb-12">
              <a href="mailto:siddique2k6@gmail.com" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors group">
                ...
                <span className="text-lg">siddique2k6@gmail.com</span>
              </a>

              <a href="tel:+918925483671" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors group">
                <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-white/10 transition-colors">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                </div>
                <span className="text-lg">+91 8925483671</span>
              </a>
              ...
              <div className="flex items-center gap-4 text-gray-300">
                ...
                <span className="text-lg">Trichy, Tamil Nadu, India</span>
              </div>
        ...
        >
          <div className="p-6 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm">
            <h4 className="text-blue-400 font-bold mb-4 uppercase tracking-wider text-sm">Personal Details</h4>
            <div className="space-y-2 text-gray-300 text-sm">
              <p><span className="text-gray-500">Father's Name:</span> Mohamed Faize Basha. B</p>
              <p><span className="text-gray-500">Date of Birth:</span> April 16, 2006</p>
              <p><span className="text-gray-500">Gender:</span> Male</p>
              <p><span className="text-gray-500">Marital Status:</span> Single</p>
              <p><span className="text-gray-500">Nationality:</span> Indian</p>
              <p><span className="text-gray-500">Religion:</span> Muslim</p>
            </div>
          </div>
          
          <div className="p-6 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm">
            <h4 className="text-blue-400 font-bold mb-4 uppercase tracking-wider text-sm">Languages Known</h4>
            <div className="flex flex-wrap gap-2">
              {["Tamil", "English", "Hindi", "Arabic", "Urdu"].map((lang) => (
                <span key={lang} className="px-3 py-1 bg-black/40 rounded-full text-sm text-gray-300 border border-white/10">
                  {lang}
                </span>
              ))}
            </div>
          ...
          <div className="p-6 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm">
            <h4 className="text-blue-400 font-bold mb-4 uppercase tracking-wider text-sm">Permanent Address</h4>
            <p className="text-gray-300 text-sm leading-relaxed">
              26, Indhira Gandhi Street,<br />
              Subramaniapuram,<br />
              Trichy – 620020,<br />
              Tamil Nadu, India
            </p>
        ...
        <footer className="mt-24 pt-8 border-t border-white/5 text-center text-gray-500 font-mono text-sm">
           <p>&copy; {new Date().getFullYear()} Abu Backer Siddique M. All rights reserved.</p>
        </footer>
      </div>
    </section>
  );
