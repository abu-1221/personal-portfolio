...
const TIMELINE_DATA = [
  {
    year: "June 2023 - April 2026",
    title: "B.Sc. Computer Science (Pursuing)",
    org: "Jamal Mohamed College, Tiruchirappalli",
    description: "Currently pursuing Bachelor of Science in Computer Science with 75.56% secured up to IV Semester. Gaining expertise in programming, web technologies, and software development.",
    type: "education",
  },
  {
    year: "2021 - 2022",
    title: "HSC - Computer Science",
    org: "Kajamian Higher Secondary School",
    description: "Completed Higher Secondary Education with Computer Science specialization. Secured 85% marks. Early exposure to programming concepts and computer fundamentals.",
    type: "education",
  },
  {
    year: "2019 - 2020",
    title: "SSLC",
    org: "Al-Jamiathus Sadhik Matriculation School",
    description: "Completed Secondary School Leaving Certificate with excellent academic performance. Secured 89.8% marks.",
    type: "education",
  },
  {
    year: "Certifications",
    ...
    description: "CABA-MDTP (Calligraphy Training - Ministry of Education & NIELIT certified), Diploma in Urdu DTP, Introduction to C Programming, NoSQL Database, AI Powered Tech Development (UI/UX Design Internship), Career Development & Communication Course.",
    type: "certification",
  },
  {
    year: "Hindi Certifications",
    title: "Hindi Language Proficiency",
    org: "Hindi Board",
    description: "Hindi Parichaya - First Class, Hindi Prathamic - First Class, Hindi Madhyama - Second Class.",
    type: "certification",
  },
];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
             Educational <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-purple-400">Journey</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
            From academic excellence to professional certifications. 
            Here is a glimpse into my educational evolution.
          </p>
        </motion.div>
